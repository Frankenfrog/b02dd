...
INPUT_FILE_NAME=DT2011_B02DD_Stripping21_DVv36r5_20150820_pseyfert_combined_TupleA_kkpikpipi.root
BASE_FILE_NAME=DT2011_B02DD_Stripping21r1_DVv36r5_20150820_pseyfert_combined_kkpikpipi
DATE=20150917
PRODUCER=fmeier
...
B02DDVariablesGrimReaper "${INPUT_PATH}${INPUT_FILE_NAME}" B02DD "${INPUT_PATH}${BASE_FILE_NAME}_${DATE}_${PRODUCER}_TupleAPlus.root" B02DD > scythe_${RUN_NAME}_${DATE}_DT2011_B02DD_vars.log
...
B02DDFlavourTaggingGrimReaper "${INPUT_PATH}${BASE_FILE_NAME}_${DATE}_${PRODUCER}_TupleD.root" B02DD "${INPUT_PATH}${BASE_FILE_NAME}_${DATE}_${PRODUCER}_TupleDPlus.root" > scythe_${RUN_NAME}_${DATE}_DT2011_B02DD_vars_preselected_massvetos_bdt_finalselection_ft.log
...
CandidateSelectionGrimReaper "${INPUT_PATH}${BASE_FILE_NAME}_${DATE}_${PRODUCER}_TupleDplus.root" B02DD "${INPUT_PATH}${BASE_FILE_NAME}_${DATE}_${PRODUCER}_TupleE.root" B02DD "idxRandom" > scythe_${RUN_NAME}_${DATE}_DT2011_B02DD_vars_preselected_bdt_finalselection_ft_random.log
