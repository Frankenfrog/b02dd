...
INPUT_FILE_NAME=DT2012_B02DD_Stripping21_DVv36r5_20150908_pseyfert_combined_TupleA_kpipikpipi.root
BASE_FILE_NAME=DT2012_B02DD_Stripping21_DVv36r5_20150908_pseyfert_combined_
DATE=20150911
PRODUCER=fmeier
...
echo ""
echo "**Tuple D** (common variables, pre-selection, vetos + PID cuts, BDT selection applied, final selection, FT variables)"
