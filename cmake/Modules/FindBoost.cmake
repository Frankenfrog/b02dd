...
if(Boost_LIBRARY_DIR)
  ...
  if(BOOST_ROOT)
    list(APPEND _boost_LIBRARY_SEARCH_DIRS ${BOOST_ROOT}/lib ${BOOST_ROOT}/stage/lib ${BOOST_ROOT}/../common/lib)
  elseif(_ENV_BOOST_ROOT)
    list(APPEND _boost_LIBRARY_SEARCH_DIRS ${_ENV_BOOST_ROOT}/lib ${_ENV_BOOST_ROOT}/stage/lib ${_ENV_BOOST_ROOT}/../common/lib)
  endif()
