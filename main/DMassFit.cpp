...
int main(int argc, char * argv[]){
  ...
  // Mass PDF
  RooRealVar        parSigDplusMassMean("parSigDplusMassMean","D Mean Mass",1870,1860,1880,"MeV/c^{2}");
  RooRealVar        parSigDplusMassSigma("parSigDplusMassSigma","Sigma of Gaussian Mass",8.0,1.0,10.0,"MeV/c^{2}");
  RooGaussian       pdfSigDplusMass("pdfSigDplusMass","Signal Mass PDF",obsMassDauOne,parSigDplusMassMean,parSigDplusMassSigma);
  
  RooRealVar        parBkgDplusExponent("parBkgDplusExponent","parBkgDplusExponent",-0.005,-1,1);
  RooExponential    pdfBkgDplusMass("pdfBkgDplusMass","pdfBkgDplusMass",obsMassDauOne,parBkgDplusExponent);

  RooRealVar        parSigDminusMassMean("parSigDminusMassMean","D Mean Mass",1870,1860,1880,"MeV/c^{2}");
  RooRealVar        parSigDminusMassSigma("parSigDminusMassSigma","Sigma of Gaussian Mass",8.0,1.0,10.0,"MeV/c^{2}");
  RooGaussian       pdfSigDminusMass("pdfSigDminusMass","Signal Mass PDF",obsMassDauTwo,parSigDminusMassMean,parSigDminusMassSigma);
  
  RooRealVar        parBkgDminusExponent("parBkgDminusExponent","parBkgDminusExponent",-0.005,-1,1);
  RooExponential    pdfBkgDminusMass("pdfBkgDminusMass","pdfBkgDminusMass",obsMassDauTwo,parBkgDminusExponent);
  ...
  Plot MassDplus(cfg_plot_mass, obsMassDauOne, *optimized_data, pdfMass, components_Dplus, "obsMassDauOne");
  MassDplus.PlotIt();

  std::vector<std::string> components_Dminus;
  components_Dminus += "pdfSigDminusMass", "pdfBkgDminusMass";
  Plot MassDminus(cfg_plot_mass, obsMassDauTwo, *optimized_data, pdfMass, components_Dminus, "obsMassDauTwo");
  MassDminus.PlotIt();
  ...
  spr.set_cut_string("obsMassDauOne>=1845&&obsMassDauOne<=1895&&obsMassDauTwo>=1845&&obsMassDauTwo<=1895&&catDDFinalState==1&&catTriggerSetTopo234BodyBBDT==1&&varKminus_PID>0.2&&varKplus_PID>0.2&&varPiOneminus_PID<0.5&&varPiOneplus_PID<0.5&&varPiTwominus_PID<0.65&&varPiTwoplus_PID<0.65");
