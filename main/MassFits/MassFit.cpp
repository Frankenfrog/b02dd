...
int main(int argc, char * argv[]){
  ...
  RooRealVar        Dminus_FDCHI2_ORIVX("Dminus_FDCHI2_ORIVX","Dminus_FDCHI2_ORIVX",0,100000);
  RooRealVar        Dplus_FDCHI2_ORIVX("Dplus_FDCHI2_ORIVX","Dplus_FDCHI2_ORIVX",0,100000);
