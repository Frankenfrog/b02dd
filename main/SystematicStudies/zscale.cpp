...
//=========================================================================================================================================================================================================================
  ...
  // Decay Time PDF
  RooBDecay         pdfSigTime_11_OS_generate("pdfSigTime_11_OS_generate","P_{S}^{l}(t,d|#sigma_{t},#eta)",obsTime,parSigTimeTau,parSigEtaDeltaG,parSigTimeCosh_11_OS,parSigTimeSinh,parSigTimeCos_11_OS,parSigTimeSin_11_OS,parSigTimeDeltaM,resModel_generate,RooBDecay::SingleSided);
  RooBDecay         pdfSigTime_11_SS_generate("pdfSigTime_11_SS_generate","P_{S}^{l}(t,d|#sigma_{t},#eta)",obsTime,parSigTimeTau,parSigEtaDeltaG,parSigTimeCosh_11_SS,parSigTimeSinh,parSigTimeCos_11_SS,parSigTimeSin_11_SS,parSigTimeDeltaM,resModel_generate,RooBDecay::SingleSided);
  RooBDecay         pdfSigTime_12_OS_generate("pdfSigTime_12_OS_generate","P_{S}^{l}(t,d|#sigma_{t},#eta)",obsTime,parSigTimeTau,parSigEtaDeltaG,parSigTimeCosh_12_OS,parSigTimeSinh,parSigTimeCos_12_OS,parSigTimeSin_12_OS,parSigTimeDeltaM,resModel_generate,RooBDecay::SingleSided);
  RooBDecay         pdfSigTime_12_SS_generate("pdfSigTime_12_SS_generate","P_{S}^{l}(t,d|#sigma_{t},#eta)",obsTime,parSigTimeTau,parSigEtaDeltaG,parSigTimeCosh_12_SS,parSigTimeSinh,parSigTimeCos_12_SS,parSigTimeSin_12_SS,parSigTimeDeltaM,resModel_generate,RooBDecay::SingleSided);
  RooBDecay         pdfSigTime_11_BS_generate("pdfSigTime_11_BS_generate","P_{S}^{l}(t,d|#sigma_{t},#eta)",obsTime,parSigTimeTau,parSigEtaDeltaG,parSigTimeCosh_11_BS,parSigTimeSinh,parSigTimeCos_11_BS,parSigTimeSin_11_BS,parSigTimeDeltaM,resModel_generate,RooBDecay::SingleSided);
  RooBDecay         pdfSigTime_12_BS_generate("pdfSigTime_12_BS_generate","P_{S}^{l}(t,d|#sigma_{t},#eta)",obsTime,parSigTimeTau,parSigEtaDeltaG,parSigTimeCosh_12_BS,parSigTimeSinh,parSigTimeCos_12_BS,parSigTimeSin_12_BS,parSigTimeDeltaM,resModel_generate,RooBDecay::SingleSided);
  RooEffProd        pdfSigTimeAcc_11_OS_generate("pdfSigTimeAcc_11_OS_generate","P_{S}^{l}(t,d|#eta)",pdfSigTime_11_OS_generate,accspline);
  RooEffProd        pdfSigTimeAcc_11_SS_generate("pdfSigTimeAcc_11_SS_generate","P_{S}^{l}(t,d|#eta)",pdfSigTime_11_SS_generate,accspline);
  RooEffProd        pdfSigTimeAcc_12_OS_generate("pdfSigTimeAcc_12_OS_generate","P_{S}^{l}(t,d|#eta)",pdfSigTime_12_OS_generate,accspline);
  RooEffProd        pdfSigTimeAcc_12_SS_generate("pdfSigTimeAcc_12_SS_generate","P_{S}^{l}(t,d|#eta)",pdfSigTime_12_SS_generate,accspline);
  RooEffProd        pdfSigTimeAcc_11_BS_generate("pdfSigTimeAcc_11_BS_generate","P_{S}^{l}(t,d|#eta)",pdfSigTime_11_BS_generate,accspline);
  RooEffProd        pdfSigTimeAcc_12_BS_generate("pdfSigTimeAcc_12_BS_generate","P_{S}^{l}(t,d|#eta)",pdfSigTime_12_BS_generate,accspline);
  ...
  RooBDecay         pdfSigTime_11_SS_fit("pdfSigTime_11_SS_fit","P_{S}^{l}(t,d|#sigma_{t},#eta)",obsTime,parSigTimeTau,parSigEtaDeltaG,parSigTimeCosh_11_SS,parSigTimeSinh,parSigTimeCos_11_SS,parSigTimeSin_11_SS,parSigTimeDeltaM,*efficiencymodel,RooBDecay::SingleSided);
  ...
  RooBDecay         pdfSigTime_12_SS_fit("pdfSigTime_12_SS_fit","P_{S}^{l}(t,d|#sigma_{t},#eta)",obsTime,parSigTimeTau,parSigEtaDeltaG,parSigTimeCosh_12_SS,parSigTimeSinh,parSigTimeCos_12_SS,parSigTimeSin_12_SS,parSigTimeDeltaM,*efficiencymodel,RooBDecay::SingleSided);
  RooBDecay         pdfSigTime_11_BS_fit("pdfSigTime_11_BS_fit","P_{S}^{l}(t,d|#sigma_{t},#eta)",obsTime,parSigTimeTau,parSigEtaDeltaG,parSigTimeCosh_11_BS,parSigTimeSinh,parSigTimeCos_11_BS,parSigTimeSin_11_BS,parSigTimeDeltaM,*efficiencymodel,RooBDecay::SingleSided);
  RooBDecay         pdfSigTime_12_BS_fit("pdfSigTime_12_BS_fit","P_{S}^{l}(t,d|#sigma_{t},#eta)",obsTime,parSigTimeTau,parSigEtaDeltaG,parSigTimeCosh_12_BS,parSigTimeSinh,parSigTimeCos_12_BS,parSigTimeSin_12_BS,parSigTimeDeltaM,*efficiencymodel,RooBDecay::SingleSided);
...
//========================================================================================================================================================================================================================
  ...
  RooExtendPdf      pdfSigExtend_11_OS_generate("pdfSigExtend_11_OS_generate","pdfSigExtend_11_OS_generate",pdfSigTimeAcc_11_OS_generate,parSigYield_11_OS);
  RooExtendPdf      pdfSigExtend_11_SS_generate("pdfSigExtend_11_SS_generate","pdfSigExtend_11_SS_generate",pdfSigTimeAcc_11_SS_generate,parSigYield_11_SS);
  RooExtendPdf      pdfSigExtend_12_OS_generate("pdfSigExtend_12_OS_generate","pdfSigExtend_12_OS_generate",pdfSigTimeAcc_12_OS_generate,parSigYield_12_OS);
  RooExtendPdf      pdfSigExtend_12_SS_generate("pdfSigExtend_12_SS_generate","pdfSigExtend_12_SS_generate",pdfSigTimeAcc_12_SS_generate,parSigYield_12_SS);
  RooExtendPdf      pdfSigExtend_11_BS_generate("pdfSigExtend_11_BS_generate","pdfSigExtend_11_BS_generate",pdfSigTimeAcc_11_BS_generate,parSigYield_11_BS);
  RooExtendPdf      pdfSigExtend_12_BS_generate("pdfSigExtend_12_BS_generate","pdfSigExtend_12_BS_generate",pdfSigTimeAcc_12_BS_generate,parSigYield_12_BS);
...
//========================================================================================================================================================================================================================
  ...
  Gaussian_Constraints.readFromFile("/home/fmeier/storage03/b02dd/Systematics/zscale/generation.par");
...
//========================================================================================================================================================================================================================
  ...
  while ((constrainingPdf = dynamic_cast<RooAbsPdf*>(iterator->Next()))){
    constrainingPdf->getParameters(*data)->readFromFile("/home/fmeier/storage03/b02dd/Systematics/zscale/generation.par");
  }
