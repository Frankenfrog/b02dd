...
//=========================================================================================================================================================================================================================
  ...
  // Resolution model
  RooRealVar                parMassTimeCorrOffset("parMassTimeCorrOffset","parMassTimeCorrOffset",-0.00096);
  RooRealVar                parMassTimeCorrScale("parMassTimeCorrScale","parMassTimeCorrScale",0.000995);
  RooFormulaVar             parResMean_generate("parResMean_generate","parResMean_generate","@0+@1*(@2-@3)",RooArgList(parMassTimeCorrOffset,parMassTimeCorrScale,obsMass,parSigMassMean));
...
//========================================================================================================================================================================================================================
  ...
  Gaussian_Constraints.readFromFile("/home/fmeier/storage03/b02dd/Systematics/CorrelationMassTime/generation.par");
...
//========================================================================================================================================================================================================================
  ...
  while ((constrainingPdf = dynamic_cast<RooAbsPdf*>(iterator->Next()))){
    constrainingPdf->getParameters(*data)->readFromFile("/home/fmeier/storage03/b02dd/Systematics/CorrelationMassTime/generation.par");
  }
  ...
  if (method.EqualTo("generate")) {
    ...
    for (int i = 0; i < 10 ; ++i) {
      ...
      try {
        data = tfac.Generate();
        pdfTime_fit.getParameters(*data)->readFromFile("/home/fmeier/storage03/b02dd/Systematics/CorrelationMassTime/generation.par");
