...
//=========================================================================================================================================================================================================================
  ...
  RooRealVar        obsEtaSS_decaytimedependent_offset("obsEtaSS_decaytimedependent_offset","obsEtaSS_decaytimedependent_offset",0.4);
  RooRealVar        obsEtaSS_decaytimedependent_slope("obsEtaSS_decaytimedependent_slope","obsEtaSS_decaytimedependent_slope",0.005);
...
//========================================================================================================================================================================================================================
  ...
  if (method.EqualTo("generate")) {
    ...
    for (int i = 0; i < 20 ; ++i) {
      ...
      try {
        data = tfac.Generate();
        // ws->allVars().readFromFile("/home/fmeier/storage03/b02dd/Systematics/MistagTimeCorrelation/generation.par");
