...
int main(int argc, char * argv[]){
  ...
  RooArgSet         observables(obsTime,obsEtaOS,obsEtaSS,obsTagOS,obsTagSS,obsTimeErr,"observables");
...
//=========================================================================================================================================================================================================================
  ...
  // Resolution model
  RooRealVar                parResMean("parResMean","parResMean",0.0);
  ...
  RooGaussModel             resmodel1("resmodel1","Gaussmodel 1",obsTime,parResMean,parResSigmaCorrection1);
  RooGaussModel             resmodel2("resmodel2","Gaussmodel 2",obsTime,parResMean,parResSigmaCorrection2);
  RooGaussModel             resmodel3("resmodel3","Gaussmodel 3",obsTime,parResMean,parResSigma_wrongPV);
  RooAddModel               resmodel("resmodel","Per event resolution model",RooArgList(resmodel3,resmodel2,resmodel1),RooArgList(parResFraction_wrongPV,parResFraction2));
...
// Decay Time Acceptance
  ...
  RooEffResAddModel       efficiencymodel("efficiencymodel","Per event resolution efficiency model",RooArgList(efficiencymodel3,efficiencymodel2,efficiencymodel1),RooArgList(parResFraction_wrongPV,parResFraction2));
...
//=========================================================================================================================================================================================================================
  ...
  RooBDecay         pdfSigTime_11_OS_generate("pdfSigTime_11_OS_generate","P_{S}^{l}(t,d|#sigma_{t},#eta)",obsTime,parSigTimeTau,parSigEtaDeltaG,parSigTimeCosh_11_OS,parSigTimeSinh,parSigTimeCos_11_OS,parSigTimeSin_11_OS,parSigTimeDeltaM,resmodel,RooBDecay::SingleSided);
  RooBDecay         pdfSigTime_11_SS_generate("pdfSigTime_11_SS_generate","P_{S}^{l}(t,d|#sigma_{t},#eta)",obsTime,parSigTimeTau,parSigEtaDeltaG,parSigTimeCosh_11_SS,parSigTimeSinh,parSigTimeCos_11_SS,parSigTimeSin_11_SS,parSigTimeDeltaM,resmodel,RooBDecay::SingleSided);
  RooBDecay         pdfSigTime_12_OS_generate("pdfSigTime_12_OS_generate","P_{S}^{l}(t,d|#sigma_{t},#eta)",obsTime,parSigTimeTau,parSigEtaDeltaG,parSigTimeCosh_12_OS,parSigTimeSinh,parSigTimeCos_12_OS,parSigTimeSin_12_OS,parSigTimeDeltaM,resmodel,RooBDecay::SingleSided);
  RooBDecay         pdfSigTime_12_SS_generate("pdfSigTime_12_SS_generate","P_{S}^{l}(t,d|#sigma_{t},#eta)",obsTime,parSigTimeTau,parSigEtaDeltaG,parSigTimeCosh_12_SS,parSigTimeSinh,parSigTimeCos_12_SS,parSigTimeSin_12_SS,parSigTimeDeltaM,resmodel,RooBDecay::SingleSided);
  RooBDecay         pdfSigTime_11_BS_generate("pdfSigTime_11_BS_generate","P_{S}^{l}(t,d|#sigma_{t},#eta)",obsTime,parSigTimeTau,parSigEtaDeltaG,parSigTimeCosh_11_BS,parSigTimeSinh,parSigTimeCos_11_BS,parSigTimeSin_11_BS,parSigTimeDeltaM,resmodel,RooBDecay::SingleSided);
  RooBDecay         pdfSigTime_12_BS_generate("pdfSigTime_12_BS_generate","P_{S}^{l}(t,d|#sigma_{t},#eta)",obsTime,parSigTimeTau,parSigEtaDeltaG,parSigTimeCosh_12_BS,parSigTimeSinh,parSigTimeCos_12_BS,parSigTimeSin_12_BS,parSigTimeDeltaM,resmodel,RooBDecay::SingleSided);
  RooEffProd        pdfSigTimeAcc_11_OS_generate("pdfSigTimeAcc_11_OS_generate","pdfSigTimeAcc_11_OS_generate",pdfSigTime_11_OS_generate,accspline);
  RooEffProd        pdfSigTimeAcc_11_SS_generate("pdfSigTimeAcc_11_SS_generate","pdfSigTimeAcc_11_SS_generate",pdfSigTime_11_SS_generate,accspline);
  RooEffProd        pdfSigTimeAcc_12_OS_generate("pdfSigTimeAcc_12_OS_generate","pdfSigTimeAcc_12_OS_generate",pdfSigTime_12_OS_generate,accspline);
  RooEffProd        pdfSigTimeAcc_12_SS_generate("pdfSigTimeAcc_12_SS_generate","pdfSigTimeAcc_12_SS_generate",pdfSigTime_12_SS_generate,accspline);
  RooEffProd        pdfSigTimeAcc_11_BS_generate("pdfSigTimeAcc_11_BS_generate","pdfSigTimeAcc_11_BS_generate",pdfSigTime_11_BS_generate,accspline);
  RooEffProd        pdfSigTimeAcc_12_BS_generate("pdfSigTimeAcc_12_BS_generate","pdfSigTimeAcc_12_BS_generate",pdfSigTime_12_BS_generate,accspline);
...
//========================================================================================================================================================================================================================
  ...
  RooExtendPdf      pdfSigExtend_11_OS("pdfSigExtend_11_OS","pdfSigExtend_11_OS",pdfSigTimeAcc_11_OS_generate,parSigYield_11_OS);
  RooExtendPdf      pdfSigExtend_11_SS("pdfSigExtend_11_SS","pdfSigExtend_11_SS",pdfSigTimeAcc_11_SS_generate,parSigYield_11_SS);
  RooExtendPdf      pdfSigExtend_12_OS("pdfSigExtend_12_OS","pdfSigExtend_12_OS",pdfSigTimeAcc_12_OS_generate,parSigYield_12_OS);
  RooExtendPdf      pdfSigExtend_12_SS("pdfSigExtend_12_SS","pdfSigExtend_12_SS",pdfSigTimeAcc_12_SS_generate,parSigYield_12_SS);
  RooExtendPdf      pdfSigExtend_11_BS("pdfSigExtend_11_BS","pdfSigExtend_11_BS",pdfSigTimeAcc_11_BS_generate,parSigYield_11_BS);
  RooExtendPdf      pdfSigExtend_12_BS("pdfSigExtend_12_BS","pdfSigExtend_12_BS",pdfSigTimeAcc_12_BS_generate,parSigYield_12_BS);
...
//========================================================================================================================================================================================================================
  ...
  Gaussian_Constraints.readFromFile("/home/fmeier/storage03/b02dd/Systematics/DecayTimeResolution/generation_fit.par");
...
//========================================================================================================================================================================================================================
  ...
  ws->import(RooArgSet(HistPdf_Sig_OS_eta,HistPdf_Sig_SS_eta,HistPdf_Sig_timeerr));
  ...
  while ((constrainingPdf = dynamic_cast<RooAbsPdf*>(iterator->Next()))){
    constrainingPdf->getParameters(*data)->readFromFile("/home/fmeier/storage03/b02dd/Systematics/DecayTimeResolution/generation_fit.par");
  }
  ...
  fitting_args.Add((TObject*)(new RooCmdArg(ConditionalObservables(RooArgSet(obsEtaOS,obsEtaSS,obsTimeErr)))));
  ...
  if (method.EqualTo("generate")) {
    ...
    for (int i = 0; i < 5 ; ++i) {
      ...
      try {
        data = tfac.Generate();
        pdfTime_fit.getParameters(*data)->readFromFile("/home/fmeier/storage03/b02dd/Systematics/DecayTimeResolution/generation_fit.par");
